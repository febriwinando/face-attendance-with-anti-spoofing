...
package go.pemkott.appsandroidmobiletebingtinggi.deteksidir.tracking;
...
public class MultiBoxTracker {
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final Pair<Float, RectF> detection : screenRects) {
      ...
      canvas.drawText("" + detection.second, rect.right, rect.top, textPaint);
      borderedText.drawText(canvas, rect.centerX(), rect.centerY(), "" + detection.second);
    }
  }
