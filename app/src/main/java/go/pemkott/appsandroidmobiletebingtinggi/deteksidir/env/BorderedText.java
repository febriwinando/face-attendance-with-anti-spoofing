...
package go.pemkott.appsandroidmobiletebingtinggi.deteksidir.env;
...
public class BorderedText {
  ...
  /**
   * Creates a left-aligned bordered text object with a background_color interior, and a black exterior with
