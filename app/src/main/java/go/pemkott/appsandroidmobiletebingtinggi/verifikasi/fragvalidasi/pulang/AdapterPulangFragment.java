...
public class AdapterPulangFragment extends RecyclerView.Adapter<AdapterPulangFragment.ListViewHolder> {
    ...
    Context context;
    private List<RekapPulangFragment> rekapServers;
    public AdapterPulangFragment(List<RekapPulangFragment> rekapServers, Context context) {
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_validasi_new, parent, false);
    ...
    public interface OnItemClickCallback {
        void onItemClicked(RekapPulangFragment data);
    }
}
