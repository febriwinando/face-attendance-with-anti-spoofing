...
public class RekapAbsensActivity extends AppCompatActivity {
    ...
    public void dataRekapServer(String idE, String dariTanggal, String sampaiTanggal){
        ...
        Call<List<RekapServer>> callRekapAbsensi = holderAPI.getUrlRekapServer("https://absensi.kotakecil.com/api/rekapserver?id="+idE+"&dtgl="+dariTanggal+"&stgl="+sampaiTanggal);
